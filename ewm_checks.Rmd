...
df <- df %>%
  ...
  rename(GEWSTAT65 = X.BIC.GEWSTAT65) %>%
  rename(GEWLSTAT = X.BIC.GEWLSTAT) %>%
  rename(GEWVOND = X.BIC.GEWVOND) %>%
  rename(GEWVONZ = X.BIC.GEWVONZ) %>%
  rename(GEWBISD = X.BIC.GEWBISD) %>%
  rename(GEWBISZ = X.BIC.GEWBISZ) %>%
  rename(GEWZEITD = X.BIC.GEWZEITD) %>%
  rename(GEWKPI = X.BIC.GEWKPI)
```